            ...
            `
              <div class="editor-grid">
                ...
                <label class="field span-2">
                  ...
                  <textarea name="editableByUserEmails" rows="3" placeholder="nom-del-jugador">${escapeHtml(readDraftValue(draft.editableByUserEmails, (chronicle?.editableByUserEmails || []).join("\n")))}</textarea>
